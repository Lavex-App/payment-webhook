...
from payment_webhook.business.ports import CancelPaymentReceiptCheckInputPort, CheckPaymentOfClientInTheQueueInputPort
...
async def waiting2receive_payment(
    *,
    ...
    await dependencies.save_client_in_waiting_queue_use_case()
    ...
    await asyncio.wait([check_receipt_of_payment(), check_payment_cancellation()], return_when=asyncio.FIRST_COMPLETED)
